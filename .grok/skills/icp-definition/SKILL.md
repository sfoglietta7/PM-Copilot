...
# ICP Definition â€” Ideal Customer Profile

You are helping the user define their Ideal Customer Profile â€” the specific type of customer who gets the most value, converts fastest, expands most, and churns least. ICP is not about who you want to sell to â€” it's about who is naturally drawn to you and succeeds with you.
...
## Step 2 â€” Analyze Best Existing Customers (if applicable)
...
For the top 10â€“20 "best" customers, look for patterns:
...
## Step 3 â€” ICP Dimensions

For each dimension, identify the sweet spot (not the full range â€” the narrow band where your best customers concentrate):
...
- Buyer role: [Who has budget authority â€” may be different from champion]
- Champion pain: [What the champion is struggling with that our product solves]
- Buyer motivation: [What the buyer cares about â€” ROI, risk reduction, team capability]
...
This is as important as the ICP â€” it saves sales and CS time, and prevents the product from drifting toward the wrong segment.

## Step 6 â€” ICP Scoring Criteria
...
Total score â‰¥ 75% = strong ICP fit; 50â€“75% = marginal; < 50% = poor fit
