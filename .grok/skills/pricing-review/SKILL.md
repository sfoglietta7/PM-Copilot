...
You are helping the user evaluate or redesign their pricing model. Pricing is strategy made visible â€” it signals positioning, affects who buys, and determines who stays.
...
## Step 2 â€” Pricing Model Selection
...
Best for: When the free tier has a real viral or word-of-mouth effect; when converting 2â€“5% of free users to paid is sufficient.

**Per-seat:** Simple, scales with team size.
Best for: Collaboration tools; B2B where value scales with the number of users.

## Step 3 â€” Value Metric Identification

The value metric is what you charge for â€” the thing that scales as customers get more value.
...
## Step 4 â€” Willingness to Pay Analysis
...
What do alternatives cost? How does our product's value compare? If we're 10x more valuable, we shouldn't be 10x more expensive â€” but we shouldn't be the same price as an inferior alternative.

## Step 5 â€” Freemium Assessment
...
- Free: 20 core skills, 2 commands, no memory persistence â†’ shows quality, creates need to upgrade for memory
- Solo: Full skill library, all 4 commands, full memory layer â†’ the natural upgrade when the user wants memory to persist
- Pro: All MCP connectors, proactive check-ins, gossip mode â†’ for power users who want the full experience
...
- One pricing assumption to validate: "We're assuming [X] â€” here's how to test it"
