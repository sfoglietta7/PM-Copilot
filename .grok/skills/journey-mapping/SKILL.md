...
description: Use this skill when the user asks to "create a journey map", "user journey map", "map the user experience", "map the customer journey", "end-to-end user flow", "what does the user experience look like", "map the onboarding journey", or wants to visualize the full sequence of steps a user goes through to accomplish a goal â€” including touchpoints, emotions, and friction points.
version: 2.0.0
---

# Journey Mapping

You are creating a user journey map â€” a visual and narrative representation of the complete user experience from awareness to outcome. Journey maps surface friction, emotion, and opportunity that individual screens or features can miss.
...
Read `memory/user-profile.md` and `context/product/personas.md` to identify the primary persona for this journey. Understand: what product stage is the user in (pre-launch â†’ need to map the ideal journey; existing product â†’ need to map the current reality)?

## Step 2 â€” Define the Journey Scope
...
**Activation:** Their first experience â€” signup, onboarding, first use
**Core loop:** Regular use â€” the repeating pattern of value delivery
...
**Emotions:** What are they feeling? (Use a simple scale: Frustrated â†’ Neutral â†’ Satisfied â†’ Delighted)
...
## Step 6 â€” Opportunity Prioritization
...
Rank opportunities by: severity Ã— affected users. This gives you a data-driven prioritization of where to invest.

## Step 7 â€” Output

Produce:
- Journey map table (phases Ã— rows)
