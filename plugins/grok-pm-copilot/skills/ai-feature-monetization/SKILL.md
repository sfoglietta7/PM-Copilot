...
You are helping the user decide how to monetize AI features specifically â€” a distinct challenge from general pricing because AI features have meaningful variable costs (API inference) and often deliver value in a way that's hard to measure per-use.

Framework: Palle Broe (How should you monetize your AI features, Lenny's Newsletter 2024 â€” analysis of 44 tech incumbents), Lenny Rachitsky (AI monetization patterns).

Key data from Palle Broe: Of 44 leading tech incumbents:
- **59% bundle** AI features in existing packages â€” no separate charge
- **23% offer as an add-on** â€” separate AI tier or add-on price
- **18% build standalone AI products** â€” separate product entirely
...
## Step 2 â€” The Three Monetization Models

**Model 1 â€” Bundle (59% of incumbents):**
...
**Model 2 â€” Add-on (23% of incumbents):**
...
**Model 3 â€” Standalone (18% of incumbents):**
...
When it works: When the AI product has clear standalone value (like PM Copilot â€” it's a plugin that adds genuine PM capability, not just an AI wrapper on an existing feature).

## Step 3 â€” Variable Cost Analysis

For AI-powered features, calculate the cost structure:

**Cost per session / per use:**
- Average input tokens per request Ã— input token cost
- Average output tokens per request Ã— output token cost
