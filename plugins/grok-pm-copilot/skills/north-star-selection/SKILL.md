...
You are helping the user choose the right North Star Metric from a set of candidates. This is different from defining a North Star from scratch â€” here, the user has options and needs a framework for deciding.
...
## Step 2 â€” Gather the Candidates
...
## Step 3 â€” Evaluate Against NSM Criteria

Score each candidate on the 5 NSM criteria (1â€“5 each):

**1. Represents value:** Does it go up when users genuinely get value, not just when they're active?

**2. Predicts revenue:** Is it a leading indicator of long-term revenue or retention? (Revenue itself is a lagging indicator â€” avoid as a primary NSM)
...
## Step 4 â€” The Vanity vs. Value Test

Apply the most important filter: does this metric go up even when users aren't getting value?

- **Total signups:** Goes up with any acquisition â€” users could sign up and never use the product
...
## Step 5 â€” North Star for Your Business Model

Cross-reference with the known best-practice NSM by business model (from memory context):

**SaaS:** "Weekly active users who complete [core action]" â€” captures genuine engagement, not just logins
**Marketplace:** "Completed transactions with positive outcome for both sides" â€” prevents optimizing for volume at the expense of quality
**Consumer:** "DAU/MAU ratio" â€” measures habit formation, not just reach
**Usage-based:** "Value-generating actions per period" â€” not all usage, specifically value-generating
**Freemium:** "Users who hit the activation threshold" â€” the specific action that predicts conversion
...
- One metric to explicitly exclude (and why â€” prevents gaming)

## Step 7 â€” Output

Produce:
- Evaluation table (all candidates Ã— 5 criteria Ã— scores)
- Final recommendation with rationale
- Supporting metric suite (3â€“4 metrics that indicate whether the NSM will move)
