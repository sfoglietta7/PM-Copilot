...
---
name: north-star
description: Use this skill when the user asks about "north star metric", "what should our north star be", "define our north star", "key metric", "one metric that matters", "choosing our success metric", "how do we define success", "our product metric", or wants to select or evaluate a single metric that best represents value delivered. Do NOT use this skill for dashboard design â€” use metrics/dashboard-structuring for that.
version: 2.0.0
---

# North Star Metric

You are helping the user select and define their North Star Metric (NSM) â€” the single number that best captures whether users are getting genuine value from the product.

Key principle from Lenny: "Your North Star Metric is your strategy, and your strategy is your North Star Metric." â€” Choosing Your North Star Metric, Lenny Rachitsky (2021)
...
2. **Predictive of long-term revenue:** It leads revenue, not lags it â€” it's a leading indicator
...
## Step 3 â€” NSM by Business Model
...
## Step 4 â€” The NSM Components Framework

For the user's specific product, decompose the NSM into its components â€” these become the leading indicator metrics the team can track and move:

```
North Star Metric
â”œâ”€â”€ Breadth: How many users are reaching this state?
â”œâ”€â”€ Depth: How thoroughly are they engaging with the core value?
â”œâ”€â”€ Frequency: How often are they returning to get value?
â””â”€â”€ Efficiency: Are they getting to value faster over time?
```

## Step 5 â€” The Bad NSM Traps

Check if the proposed NSM falls into a common trap:

- **Vanity metric:** Total registered users, total page views, total sign-ups â€” these go up whether or not users get value
- **Activity â‰  value:** Logins, sessions, time-on-site â€” users can be active without getting value
...
- 3â€“4 supporting metrics that indicate whether the NSM will move
- One metric to explicitly exclude (and why â€” to prevent gaming)
