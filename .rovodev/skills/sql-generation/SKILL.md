...
---
name: sql-generation
description: Use this skill when the user asks to "write a SQL query", "help me query this data", "how do I get this metric from the database", "generate SQL for", "query for retention", "SQL to find churned users", "write a query for my analytics", or needs SQL to answer a specific product analytics question. This skill generates standard SQL for product analytics use cases â€” it assumes a typical event-based analytics schema.
version: 2.0.0
---
...
## Step 3 â€” Common Product Analytics Queries
...
## Step 4 â€” Adapt to the User's Request
