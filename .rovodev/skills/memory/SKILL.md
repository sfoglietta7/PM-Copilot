...
1. **Product context** â€” name, stage, core problem, business model, current bets
2. **Stack** â€” which tools are connected (issue tracker, docs, comms, analytics)
3. **Working style** â€” PRD format preference, verbosity, preferred frameworks
4. **Stakeholders** â€” names, roles, communication styles, sensitivities
5. **Roadmap state** â€” what's in Now/Next/Later, what's been decided and why
6. **Open questions** â€” unresolved assumptions and risks
7. **Tracked risks** â€” active risks with dates flagged
8. **Lessons learned** â€” retrospective outcomes from past initiatives
...
**Resolve, don't delete:** When a risk is resolved or a question is answered, update its status and add a resolution note â€” don't remove the entry. This preserves institutional knowledge.
...
Look for:
- **People + opinions:** "[Name] said [X]" â†’ potential stakeholder note
- **Blockers:** "[X] is blocked because [Y]" â†’ tracked risk candidate
- **Decisions:** "We decided to [X]" â†’ `decided_and_why` candidate
- **Product changes:** "We're not doing [X] anymore" â†’ roadmap state update
- **Customer signals:** "[Customer] complained about [X]" â†’ potential open question or persona note
- **Timeline shifts:** "[Item] is slipping to [date]" â†’ roadmap state update
